 ...
 * @internal
 */
function createΔsByVertex(
        delunay: Delaunator<unknown>): Map<number, number[]> {

    const $triangles: Uint32Array = delunay.triangles;
    /**
     ...
     * and are always a number that is a multiple of 3.
     */
    const ΔsByVertex: Map<number,number[]> = new Map();
